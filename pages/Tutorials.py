...
app_mode = st.sidebar.selectbox("", ["Roboflow Annotation", "AI Projects", "Projects", "Tutorials", "Front Page"])
...
tutorials = [
    {"image": "figures/banners/watercolour/watercolour1.png", "description": "Tutorial 1 Description"},
    {"image": "figures/banners/watercolour/watercolour1.png", "description": "Tutorial 2 Description"},
    {"image": "figures/banners/watercolour/watercolour1.png", "description": "Tutorial 3 Description"},
    {"image": "figures/banners/watercolour/watercolour1.png", "description": "Tutorial 4 Description"},
    {"image": "figures/banners/watercolour/watercolour1.png", "description": "Tutorial 1 Description"},
    {"image": "figures/banners/watercolour/watercolour1.png", "description": "Tutorial 2 Description"},
    {"image": "figures/banners/watercolour/watercolour1.png", "description": "Tutorial 3 Description"},
    {"image": "figures/banners/watercolour/watercolour1.png", "description": "Tutorial 4 Description"},
...
st.title("Tutorials")
st.write("Welcome to the tutorials page! Here you can find various tutorials on different topics.")
...
for row in range(num_rows):
    ...
    for idx, col in enumerate(cols):
        ...
        if tutorial_index < len(tutorials):
            with col:
                display_tutorial(tutorials[tutorial_index]["image"], tutorials[tutorial_index]["description"])
