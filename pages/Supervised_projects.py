...
from utils.achievement import print_project_info
...
st.write(
    "I have supervised a number of projects at both BSc. and MSc. level. The projects are listed below. If you are interested in doing a project with me, please contact me at. "
)
